...
class uploader(threading.Thread):
    ...
    def __init__(self):
        ...
        self.heartbeat_time = [ti.time() for _ in range(COM_CNT+DCS_CNT)]
    ...
    def publish_heartbeat(self):
        ...
        threading.Timer(self.heartbeat_check_interval, self.publish_heartbeat).start()
    ...
    def publish_dewar_list(self):
        ...
        hk_entries = [self.hk_list[GEA_VACUUM],
                      ...
                      cur_pa, self.pixelscale]  #add 20240119
